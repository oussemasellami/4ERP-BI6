...
message:string=""
  ...
  listResidences:Residence[]=[
   ...
   listApartments:Apartment[]=[
    ...
    {id:3,"appartNum":3,"floorNum":1,"surface":150,"terrace":"oui","surfaceTerrace":30,"category":"S+3","description":"Appartement S+3","residence":this.listResidences[1] },]
   
   
   s!:number
    somme(){
      this.s=this.residenceservice.getNumber(this.listApartments,"floorNum",1)
    }
